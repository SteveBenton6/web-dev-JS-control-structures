...
function detectFirstButton(event) {
  console.log("First Button Clicked");
  console.dir(firstButtonElement);
  thirdParagraphElement.remove();
}
firstButtonElement.addEventListener("click", detectFirstButton);

function detectSecondButton(event) {
  console.log("Second Button Clicked");
  console.dir(event.target);
  //   firstParagraphElement.style.backgroundColor = "blue";
  firstParagraphElement.classList.add("first-para-blue");
}
secondButtonElement.addEventListener("click", detectSecondButton);
